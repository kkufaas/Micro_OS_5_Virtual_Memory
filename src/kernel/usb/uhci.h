 ...
 */
struct ATTR_PACKED ATTR_ALIGNED(16) uhci_queue_head {
...
struct ATTR_PACKED ATTR_ALIGNED(16) uhci_transfer_descriptor {
...
#define UHCI_LP_VF \
    (1 << 2) /* Switch depth (1)/breadth first, valid only for TDs in queues \
              */
#define UHCI_LP_QH \
